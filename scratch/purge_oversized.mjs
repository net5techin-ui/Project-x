...
async function purgeOversized() {
  console.log('Purging oversized products (ID 118, 119) to restore site functionality...');
  ...
  if (error) {
    ...
    console.log('Purged IDs 118 and 119. LocalStorage quota should now be safe.');
  }
}
